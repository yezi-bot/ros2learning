...
#include "example_ros_interfaces/msg/detail/robot_pose__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_example_ros_interfaces
...
using _RobotPose__ros_msg_type = example_ros_interfaces__msg__RobotPose;
...
static uint32_t _RobotPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_ros_interfaces__msg__RobotPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_ros_interfaces__msg__RobotPose;
    is_plain =
      (
...
static size_t _RobotPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_ros_interfaces__msg__RobotPose(
