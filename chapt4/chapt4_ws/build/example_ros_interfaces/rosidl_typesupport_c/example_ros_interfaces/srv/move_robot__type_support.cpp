...
static const _MoveRobot_Request_type_support_symbol_names_t _MoveRobot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_ros_interfaces, srv, MoveRobot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_ros_interfaces, srv, MoveRobot_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, example_ros_interfaces, srv, MoveRobot_Request)() {
  return &::example_ros_interfaces::srv::rosidl_typesupport_c::MoveRobot_Request_message_type_support_handle;
}
...
static const _MoveRobot_Response_type_support_symbol_names_t _MoveRobot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_ros_interfaces, srv, MoveRobot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_ros_interfaces, srv, MoveRobot_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, example_ros_interfaces, srv, MoveRobot_Response)() {
  return &::example_ros_interfaces::srv::rosidl_typesupport_c::MoveRobot_Response_message_type_support_handle;
}
...
static const _MoveRobot_type_support_symbol_names_t _MoveRobot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_ros_interfaces, srv, MoveRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, example_ros_interfaces, srv, MoveRobot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, example_ros_interfaces, srv, MoveRobot)() {
  return &::example_ros_interfaces::srv::rosidl_typesupport_c::MoveRobot_service_type_support_handle;
}
