...
class Metaclass_MoveRobot_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('example_ros_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'example_ros_interfaces.srv.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from example_ros_interfaces.srv import _move_robot
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    from example_ros_interfaces.srv._move_robot import MoveRobot_Request as Request
    from example_ros_interfaces.srv._move_robot import MoveRobot_Response as Response
