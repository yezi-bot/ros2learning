...
#include "example_ros_interfaces/srv/detail/move_robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_ros_interfaces
cdr_serialize(
  const example_ros_interfaces::srv::MoveRobot_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_ros_interfaces::srv::MoveRobot_Request & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_ros_interfaces::srv::MoveRobot_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_ros_interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_ros_interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_example_ros_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<example_ros_interfaces::srv::MoveRobot_Request>()
{
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_ros_interfaces, srv, MoveRobot_Request)() {
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_ros_interfaces
cdr_serialize(
  const example_ros_interfaces::srv::MoveRobot_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_ros_interfaces::srv::MoveRobot_Response & ros_message)
{
  // Member: pose
  cdr >> ros_message.pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_ros_interfaces::srv::MoveRobot_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_ros_interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_ros_interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_ros_interfaces, srv, MoveRobot_Response)() {
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
{
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_ros_interfaces, srv, MoveRobot)() {
  return &example_ros_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
